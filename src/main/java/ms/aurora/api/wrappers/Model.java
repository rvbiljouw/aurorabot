...
public final class Model {
    ...
    public Model(IModel wrapped, int localX, int localY, int orientation) {
    ...
    public Polygon[] getPolygons() {
        ...
        for (int i = 0; i < trianglesX.length; i++) {
            ...
            Point x = Viewport.convert(new Tile(localX, localY), verticesX[trianglesX[i]], verticesZ[trianglesX[i]], -verticesY[trianglesX[i]]);
            Point y = Viewport.convert(new Tile(localX, localY), verticesX[trianglesY[i]], verticesZ[trianglesY[i]], -verticesY[trianglesY[i]]);
            Point z = Viewport.convert(new Tile(localX, localY), verticesX[trianglesZ[i]], verticesZ[trianglesZ[i]], -verticesY[trianglesZ[i]]);
