...
/**
 * this class will act like a touch screen, moving the mouse directly to the points specified.
 *
 * @author tobiewarburton
 */
public class TouchScreenProvider implements MouseProvider {
    private Random random = new Random();
    private Component component;
    /**
     * this is the amount of pixels the mouse will be allowed to deviate from the actual destination,
     * the real figure of the maximum deviation is randomness * 2.
     */
